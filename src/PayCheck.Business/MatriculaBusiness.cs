    ...
    public class MatriculaBusiness : BaseBusiness
    {
        ...
        public MatriculaDto Get(Guid guid)
        {
            try
            {
                ...
                {
                    var entity = connection.Repositories.MatriculaRepository.Get(
                        guid);
        ...
        public MatriculaDto GetByMatricula(string matricula)
        {
            try
            {
                ...
                using (var connection = this._unitOfWork.Create())
                {
                    var entity = connection.Repositories.MatriculaRepository.GetByMatricula(
                        matricula);
        ...
        public void Delete(Guid guid)
        {
            ...
            try
            {
                ...
                connection.Repositories.MatriculaRepository.Delete(
                    guid);
        ...
        public MatriculaDto SaveData(MatriculaDto dto)
        {
            ...
            try
            {
                ...
                {
                    entity = connection.Repositories.MatriculaRepository.Update(
                        entity);
                }
                else
                {
                    entity = connection.Repositories.MatriculaRepository.Create(
                        entity);
                }
